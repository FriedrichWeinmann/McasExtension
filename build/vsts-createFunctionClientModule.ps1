...
$parentModule = 'McasExtension'
if (-not $ModuleName) { $ModuleName = 'McasExtension.Client' }
...
$publishRoot = Join-Path -Path $WorkingDirectory -ChildPath 'publish\McasExtension'
...
$originalManifestData = Import-PowerShellDataFile -Path "$publishRoot\McasExtension.psd1"
$prereqHash = @{
